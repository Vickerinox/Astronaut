...
use reboot_lib::{ENGINE_A_PALETTES, ENGINE_B_PALETTES, StorageSector, arm9_check_sdmmc, arm9_init_sdmmc};

use crate::{EMMC_ERROR, SD_ERROR, mbr, nand::BasicSDMMCCursor, read_encrypted_nand, read_sd_card, transmute_slice};
...
pub struct SDMMCDriver {
    ...
    pub sd_controller: Option<BasicSDMMCCursor<'static>>,
}
