...
fn main() {
    ...
    let boostrap_bin =
        build_tools::build_binaries::compile_bootstrap(elf9_file_path.clone(), dest_path.clone())
    ...
    let boostrap_bin =
        build_tools::build_binaries::compile_arm7(elf7_file_path.clone(), dest_path.clone())
